...
int main() {
  ...
  std::string fname = "circle_fae"; fname += "_" + to_string(m)+ "_" + to_string(numpanels);
  std::string fname1 = "circle_qae"; fname1 += "_" + to_string(m)+ "_" + to_string(numpanels);
  std::string fname4 = "circle_lrae"; fname4 += "_" + to_string(m)+ "_" + to_string(numpanels);
  ...
  FF F(R,r); // Defines the vector field F. div(F) = f

  func f(R, r); // Defines the function f appearing in the volume integral
  ...
  // This lambda function computes the perturbed shape functional exactly
  ...
  // This lambda function computes the shape functional
